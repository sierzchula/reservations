...
@endif
    ...
    <form method="POST" action="{{ route('clients.store') }}">
        ...
        <div class="form-group">
            ...
            <input name="address" value="{{ old('address') }}" type="text" max="255" class="form-control" id="address">
        </div>
        <div class="form-group">
            <label for="email">{{__('E-mail')}}:</label>
            <input name="email" value="{{ old('email') }}" type="email" max="255" class="form-control" id="email">
        </div>
        <div class="form-group">
