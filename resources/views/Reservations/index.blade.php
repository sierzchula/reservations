...
<div class="d-flex justify-content-between w-100">
    <a class="d-flex" href="{{ route('reservations.indexdate', [ date("Y", strtotime( request()->route('month') . "/01/" . request()->route('year') . " -3 month") ), date("m", strtotime( request()->route('month') . "/01/" . request()->route('year') . " -3 months") )]) }}"> {{ date("Y/m", strtotime( request()->route('month') . "/01/" . request()->route('year') . " -3 months") ) }}</a>
    <a class="d-flex" href="{{ route('reservations.indexdate', [ date("Y", strtotime( request()->route('month') . "/01/" . request()->route('year') . " -2 month") ), date("m", strtotime( request()->route('month') . "/01/" . request()->route('year') . " -2 months") )]) }}"> {{ date("Y/m", strtotime( request()->route('month') . "/01/" . request()->route('year') . " -2 months") ) }}</a>
