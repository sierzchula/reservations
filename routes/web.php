...
Route::delete(  '/reservations/{reservation}',      'ReservationsController@destroy')->name('reservations.destro            y');
...
Route::get(     '/apartments/{apartment}/edit',     'ApartmentsController@edit')->name(     'apartments.e        dit');
Route::put(     '/apartments/{apartment}',          'ApartmentsController@update')->name(   'apartments.u        pdate');
Route::delete(  '/apartments/{apartment}',          'ApartmentsController@destroy')->name(  'apartments.destr        oy');
